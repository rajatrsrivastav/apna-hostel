...
const variants = {
  ...
  pending: ["bg-amber-50 text-amber-800", "Verification pending", Clock3],
  checkout_started: ["bg-blue-50 text-blue-800", "Checkout started", Clock3],
  cancelled: ["bg-red-50 text-red-700", "Cancelled", X],
  abandoned: ["bg-red-50 text-red-700", "Checkout expired", Clock3],
  processing: ["bg-blue-50 text-blue-800", "Checkout started", Clock3],
